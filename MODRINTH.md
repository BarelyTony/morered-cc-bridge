...
Minecraft 1.21.1. Same idea, new internals — the old approach is no longer possible (see
...
| Minecraft | 26.1.2 | |
| NeoForge | 26.1.2+ | |
| CC: Tweaked | 1.118+ | Modrinth (**not** CurseForge — that page is abandoned at 1.21.1) |
| More Red | 26.1.0.5+ | **CurseForge only** |

> [!IMPORTANT]
> **Get More Red from CurseForge.** Its Modrinth page is stale — the newest version there is
> 1.20.1 from 2023, and it will not work with this mod.
>
...
driving this" from "something else is". This matches a real bundled cable, but differs from CC's
